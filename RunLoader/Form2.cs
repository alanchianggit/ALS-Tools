...
namespace AccessBlob
{
    ...
    {
        private const string ACCESS_FILE_FILTER = "Microsoft Access (*.accdb)|*.*|All Files (*.*)|*.*";
        ...
        private void UploadFile_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                conn = new System.Data.OleDb.OleDbConnection("Provider=Microsoft.ACe.OLEDB.12.0;Data Source=" + AccessFile.Text);
                conn.Open();
