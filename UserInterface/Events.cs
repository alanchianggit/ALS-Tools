...
namespace ALSTools
{
    ...
    public partial class frm_Event : BaseOperationForm
    {
        ...
        private void ActivateDateTimePicker(DataGridView dgv, DataGridViewCellMouseEventArgs e)
        {
        ...
        private void Dtp_LostFocus(object sender, EventArgs e)
        {
            ...
            //1.Need to allow tab
            //2. GetData() cannot be referenced in this event handler
